import{Bb as m,Cb as y,Cd as q,Dd as g,Eb as j,Fb as S,Fd as A,Hd as P,Ia as o,Lb as z,N as v,O as h,Sa as b,T,Ta as C,Wa as $,Ya as r,aa as p,ac as B,db as i,gb as k,hb as I,mb as u,nb as d,ob as x,pb as M,pc as Q,qb as w,rc as E,tc as N,vb as l,vc as O,wb as D,xb as F,zb as f}from"./chunk-NQGTOHWB.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
